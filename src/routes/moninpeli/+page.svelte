<script lang="ts">
    ...
    import { checkAlive, joined_game_data, poll_id_index, poll_board_string, poll_game, poll_other_boards_string, poll_send_moves, poll_success, server_status } from '$lib/stores/tournamentstore';
